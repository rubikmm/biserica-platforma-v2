...
- Verificat pe viu, doar GET: toate **11 → 200**, cu versiunea nouă în subsol (home pe `website.sfantul-ilie.ro`); la curățenie `grep -c "cu-platforma"` → **0**, cum se aștepta. Commit `HASH_RUNDA`.
