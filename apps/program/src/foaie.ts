...
// ---------------------------------------------------------------------------
// Hartiile: PDF, JPG, PNG si cache-ul lor au urcat in @xc/ui (packages/ui/src/hartie.ts) la
// 10.09.2026, cand calendarul a avut nevoie de acelasi lucru pentru poza saptamanii. Se trec mai
